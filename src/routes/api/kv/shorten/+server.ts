 ...
 */
const getOrCreateShortUrl = async(ns: KVNamespace, url: string, urlHash: string): Promise<App.URLData> => {
  ...
  if (kvData) {
    ...
    urlData = <URLData>{
      ...
      userAgent: undefined,
      userIP: undefined,
      geoData: { latitude: undefined, longitude: undefined, continent: undefined, country: undefined, city: undefined, timezone: undefined, region: undefined }
    };
  }
